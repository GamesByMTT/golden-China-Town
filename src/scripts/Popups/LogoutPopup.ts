...
export default class LogoutPopup extends GameObjects.Container{
    ...
    constructor(scene: Scene){
        super(scene);
         ...
         const popupBg = this.scene.add.image(gameConfig.scale.width * 0.5, gameConfig.scale.height * 0.5, 'messagePopupBgImage').setDepth(10);
                ...
                const crossButton = new Phaser.GameObjects.Sprite(this.scene, gameConfig.scale.width * 0.5 + 300, gameConfig.scale.height * 0.5 - 250, "exitButton").setInteractive()
                ...
                this.yesBtn.setPosition(gameConfig.scale.width * 0.5 - 130, gameConfig.scale.height * 0.5 + 200).setScale(0.8);
                this.noBtn.setPosition(gameConfig.scale.width * 0.5 + 130, gameConfig.scale.height * 0.5 + 200).setScale(0.8);
                // Button labels
